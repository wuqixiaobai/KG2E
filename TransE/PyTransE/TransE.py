...
if __name__ == '__main__':
    dirEntity = "/Users/wenqiangliu/Documents/KGEmbedding/data/FB15k/entity2id.txt"
    entityIdNum, entityList = openDetailsAndId(dirEntity)
    dirRelation = "/Users/wenqiangliu/Documents/KGEmbedding/data/FB15k/relation2id.txt"
    relationIdNum, relationList = openDetailsAndId(dirRelation)
    dirTrain = "/Users/wenqiangliu/Documents/KGEmbedding/data/FB15k/train.txt"
    ...
    transE.initialize()
    transE.transE(15000)
    transE.writeRelationVector("/Users/wenqiangliu/Documents/KGEmbedding/data/FB15k/relationVector.txt")
    transE.writeEntilyVector("/Users/wenqiangliu/Documents/KGEmbedding/data/FB15k/entityVector.txt")